                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_searchResults.isEmpty && !_isLoading)
                            const Expanded(child: Center(child: Text('Enter a skill to find matching students.')))
                          else
                            Expanded(
                              child: GridView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return Card(
                                    child: InkWell(
                                      onTap: () => Navigator.pushNamed(context, '/admin/student-detail', arguments: student),
                                      child: Padding(
