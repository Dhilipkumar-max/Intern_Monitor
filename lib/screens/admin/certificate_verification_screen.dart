...
class _CertificateVerificationScreenState
  ...
  Future<void> _verifyCertificate(int id, bool approved) async {
    ...
    if (approved) {
      ...
      success = await _adminService.rejectCertificate(
        id,
        adminId,
                        ...
                        children: [
                          ...
                          Expanded(
                            child: _pendingCertificates.isEmpty
                                ? const Center(
                                    child: Text(
                                      'No pending certificates for verification.',
                                    ),
                                  )
                                : ListView.builder(
                                              ...
                                              Expanded(
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    const SizedBox(height: 4),
                                                    const Text(
                                                      'Type: Academic/Professional Certificate',
                                                      style: TextStyle(
                                                        fontSize: 12,
                                                        color: AppTheme
                                                            .textSecondary,
